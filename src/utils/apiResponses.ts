...
function successResponse<Data>(code: number, data: Data, message?: string): NextResponse {
...
export function send200<Data>(data: Data, message: string = "Request was successful"): NextResponse {
...
export function send500(message: string = "Internal Server Error"): NextResponse {
